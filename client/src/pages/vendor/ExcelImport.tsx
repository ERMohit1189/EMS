...
export default function ExcelImport() {
  ...
  const handleImport = async () => {
    ...
    for (let idx = 0; idx < importedData.length; idx++) {
      ...
      try {
        if (importType === 'site') {
          // Helper function to convert values to strings (handles Excel numbers/dates)
          ...
          const siteData = {
            ...
            srDateSiteA: toString(row['SR DATE SITE A']),
            srNoSiteB: toString(row['SR NO SITE B']),
            srDateSiteB: toString(row['SR DATE SITE B']),
            hopSrDate: toString(row['HOP SR DATE']),
            spDateSiteA: toString(row['SP DATE SITE A']),
            spDateSiteB: toString(row['SP DATE SITE B']),
            hopSpDate: toString(row['HOP SP DATE']),
            soReleasedDateSiteA: toString(row['SO RELEASED DATE SITE A']),
            soReleasedDateSiteB: toString(row['SO RELEASED DATE SITE B']),
            hopSoDate: toString(row['HOP SO DATE']),
            rfaiOfferedDateSiteA: toString(row['RFAI OFFERED DATE SITE A']),
            rfaiOfferedDateSiteB: toString(row['RFAI OFFERED DATE SITE B']),
            actualHopRfaiOfferedDate: toString(row['ACTUAL HOP RFAI OFFERED DATE']),
            partnerName: toString(row['PARTNER NAME']),
            rfaiSurveyCompletionDate: toString(row['RFAI SURVEY COMPLETION DATE']),
            moNumberSiteA: toString(row['MO NUMBER SITE A']),
            materialTypeSiteA: toString(row['MATERIAL TYPE SITE A(SRN, FRESH, FRESH+SRN)']),
            moDateSiteA: toString(row['MO DATE SITE A']),
            moNumberSiteB: toString(row['MO NUMBER SITE B']),
            materialTypeSiteB: toString(row['MATERIAL TYPE SITE B(SRN, FRESH, FRESH+SRN)']),
            moDateSiteB: toString(row['MO DATE SITE B']),
            srnRmoNumber: toString(row['SRN/RMO NUMBER']),
            srnRmoDate: toString(row['SRN/RMO DATE']),
            hopMoDate: toString(row['HOP MO DATE']),
            hopMaterialDispatchDate: toString(row['HOP MATERIAL DISPATCH DATE']),
            hopMaterialDeliveryDate: toString(row['HOP MATERIAL DELIVERY DATE']),
            materialDeliveryStatus: toString(row['MATERIAL DELIVERY STATUS']),
            siteAInstallationDate: toString(row['SITE A INSTALLATION DATE']),
            ptwNumberSiteA: toString(row['PTW Number(Site A)']),
            ptwStatusA: toString(row['PTW Status A']),
            siteBInstallationDate: toString(row['SITE B INSTALLATION DATE']),
            ptwNumberSiteB: toString(row['PTW Number(Site B)']),
            ptwStatusB: toString(row['PTW Status B']),
            hopIcDate: toString(row['HOP I&C DATE']),
            alignmentDate: toString(row['Alignment Date']),
            hopInstallationRemarks: toString(row['HOP Installation Remarks']),
            visibleInNms: toString(row['VISIBLE IN NMS']),
            nmsVisibleDate: toString(row['NMS VISIBLE DATE']),
            softAtOfferDate: toString(row['SOFT AT OFFER DATE']),
            softAtAcceptanceDate: toString(row['SOFT AT ACCEPTANCE DATE']),
            softAtStatus: toString(row['SOFT-AT STATUS']),
            phyAtOfferDate: toString(row['PHY-AT OFFER DATE']),
            phyAtAcceptanceDate: toString(row['PHY-AT ACCEPTANCE DATE']),
            ...
            priOpenDate: toString(row['PRI OPEN DATE']),
            priCloseDate: toString(row['PRI CLOSE DATE']),
            priHistory: toString(row['PRI HISTORY']),
            rfiSurveyAllocationDate: toString(row['RFI Survey Allocation Date']),
            ...
            wccReceivedDate80Percent: toString(row['WCC Received Date 80%']),
            wccReceived20Percent: toString(row['WCC Received 20%']),
            wccReceivedDate20Percent: toString(row['WCC Received Date 20%']),
            wccReceivedDate100Percent: toString(row['WCC Received Date 100%']),
            survey: toString(row['Survey']),
            finalPartnerSurvey: toString(row['Final Partner Survey']),
            surveyDate: toString(row['Survey Date']),
