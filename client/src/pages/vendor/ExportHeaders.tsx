...
const FOOTER_SUGGESTIONS = [
  ...
  {
    label: 'Brief & Clean',
    text: 'Confidential - For authorized use only. Document generated by EOMS Portal. For questions, contact support.'
  },
  {
    label: 'Complete Information',
    text: 'CONFIDENTIAL: This report contains proprietary business information. Reproduction or distribution without authorization is prohibited. © 2025 Enterprise Operations Management System (EOMS). All rights reserved.'
  },
  {
    label: 'Compliance Focused',
    text: 'This is an official document generated by the EOMS Portal. Please verify data accuracy before making business decisions. Report validity: Current as of generation date only.'
  },
  {
    label: 'Simple & Direct',
    text: 'Generated by EOMS Portal - Confidential. For internal use only. Do not distribute without authorization.'
  }
];
